...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <form method="POST" action="{{ route('admin.items.books.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-8">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="isbn" id="isbn" value="{{ old('isbn') }}"
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"
                                                ...
                                                name="pages" id="pages" value="{{ old('pages') }}"
                                                placeholder="Input here...">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <label class="form-radio-label">
                                            <input class="form-radio-input" type="radio" name="ebook_available"
                                                id="available" value="1" {{ old('ebook_available')=='1' ? 'checked' : ''
                                                }}>
                                            <span class="form-radio-sign">Available</span>
                                        </label>
                                        <label class="form-radio-label ml-4">
                                            <input class="form-radio-input" type="radio" name="ebook_available"
                                                id="unavailable" value="0" {{ old('ebook_available')=='0' ? 'checked'
                                                : '' }}>
                                        ...
                                        <div class="form-group" id="ebook-parent" @error('ebook_url') "style='display:block'" @else "style='display:none'" @enderror>
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                name="description" id="description" placeholder="Input here..."
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                class="form-control form-control-sm @error('table_of_contents') is-invalid @enderror"
                                                name="table_of_contents" id="table_of_contents"
                                                placeholder="Input here..."
                                                rows="5">{{ old('table_of_contents') }}</textarea>
                                        ...
                                        <div class="form-group" id="author-select">
                                            ...
                                            <select
                                                ...
                                                <option value="{{ $author->id }}" @if ($errors->any() &&
                                                    old('author_id') !== null) @for ($idx = 0; $idx <
                                                        count(old('author_id')); $idx++) {{
                                                        old('author_id')[$idx]==$author->id ? 'selected' : '' }} @endfor
                                                        @endif>
                                                        {{ $author->name }}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                <option value="{{ $rack->id }}" {{ old('rack_id')==$rack->id ?
                                                    'selected' : '' }}>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        ...
                                        name="total_qty" id="total_qty" value="{{ old('total_qty') }}"
                                        placeholder="Input here...">
...
<script>
    $(document).ready(function () {
        ...
        $('body').on('keyup change', '#year, #pages, #edition, #total_qty', function () {
            var test = $(this).val();
            if (test == '') {
                $(this).removeClass('is-valid is-invalid');
            } else {

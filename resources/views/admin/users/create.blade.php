                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password"
                                        ...
                                        autocomplete="off">
                                    <div class="invalid-feedback" id="valid-password">{{ $errors->first('password') }}
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <select
                                                class="select2 form-control form-control-sm @error('faculty_id') is-invalid @enderror"
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('address') is-invalid @enderror"
                                                name="address" id="address" placeholder="Input here..."
...
<script>
    $(document).ready(function () {
        ...
        $('body').on('keyup',
            '#role_name, #sn, #name, #username, #email, #password, #password-confirm, #address',
            function () {
                var test = $(this).val();
                if (test == '') {
        ...
        $('#btn-save').click(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#role-parent').load(
                        "{{ route('admin.users.create') }}" + '#role-select', function () {
                            // Open Modal to Add new role
                            $('#btn-add').click(function (e) {
                                e.preventDefault();
                                $('#formModal').modal('show');
